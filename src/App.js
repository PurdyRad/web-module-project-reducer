...
import reduce, {initialState} from './reducers/index';
import {addOne, applyNumber, changeOperation, clearDisplay, currentMemory, totalMemory, clearMemory} from './actions/index';
      ...
      <div className = "container row mt-5">
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              <CalcButton value={"M+"} onClick={() => dispatch(currentMemory())}/>
              <CalcButton value={"MR"} onClick={() => dispatch(totalMemory())}/>
